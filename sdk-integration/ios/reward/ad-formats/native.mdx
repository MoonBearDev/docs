...
<Accordion title="DaroMNativeAdContentContainerView.swift" icon="sparkles">
  ```swift showLineNumbers
...
<Accordion title="RootViewController.swift" icon="sparkles">
  ```swift
  import DaroM
...
<Accordion title="TabBarViewController.swift" icon="sparkles">
  ```swift
...
![/sdk-integration/ios/reward/ad-formats/img/ios-line-native-template-example.png+_existingInIndexedDbMintlify](/sdk-integration/ios/reward/ad-formats/img/ios-line-native-template-example.png)